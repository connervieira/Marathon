    ...
    <body>
        ...
        <main class="centered">
            <form action="configurationchange.php" method="POST" style="color:white;">
                ...
                echo '<label for="clockinverificationkey">Shift Verification Key: </label><input name="clockinverificationkey" id="clockinverificationkey" type="text" value="' . $configuration_database["clockinverificationkey"] . '"><br>';

...
6. Enter the currency your business uses in the "Business Currency Symbol" field.
    ...
    - This setting doesn't have any functional purpose, and it simply is used to make sure everyone is on the same page. This setting can be changed at any time without any effect on the rest of Marathon.

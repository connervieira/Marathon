...
6. After you've configured the settings explained above, click 'Submit' to save configuration changes.
7. The base configuration of Marathon is now complete. You can now begin adding employees and positions to your Marathon instance.

...
<html lang="en" style="background:<?php echo $background_gradient_bottom; ?>;">
    ...
    <body>
        <div style="background:linear-gradient(0deg, <?php echo $background_gradient_bottom; ?>, <?php echo $background_gradient_top; ?>);color:#111111;">
            <main>
                <a class="button" role="button" href="tools.php">Back</a>
                <h1>All Shifts</h1>
                <br><hr class="separator-thick"><br>
                <div class="centered">
                    <?php

        ...
        <div class="projects-clean" style="background:linear-gradient(0deg, <?php echo $background_gradient_bottom; ?>, <?php echo $background_gradient_top; ?>);color:#111111;">
            <div class="container" style="padding-top:100px;">
                <main>
                    ...
                    <div class="intro">
                        <p class="text-center" style="padding-bottom:54px;color:#dddddd;font-size:40px;">All Shifts</p>
                    </div>
                    ...
                    <?php
                        ...
                        foreach ($employee_database as $key1 => $element1) {
                            ...
                            if ($employee_has_valid_shifts == true) {
                                echo "<p style='color:white;font-size:25px;'><a style='text-decoration:underline;color:white;' target='_blank' href='viewpaymentinformation.php?employee=" . $key1 . "'>" . $element1["firstname"] . " " . $element1["lastname"] . "'s</a> Valid Shifts</p>";
                                ...
                                foreach($timecard_database[$key1] as $key2 => $element2) {
                                    if ($element2["valid"] == true and isset($element2["timeout"]) and $element2["valid"] == true) {
                                        ...
                                        echo '<a class="btn btn-primary" role="button" href="allshifts.php?employee=' . $key1 . '&shift=' . $key2 . '" style="background-color:#444444;border-color:#eeeeee">Mark As Invalid</a>';
                                        echo "<br><br><br>";
                                        echo "<hr>";
                                    }
                                }
                        ...
                        if ($anyone_has_valid_shifts == false) {
                            echo "<p style='color:white;'>There are currently no valid shifts!</p>";
                        }
                        echo "<br><br>";
                        ?>
                    </div>
